...
<style>
body {background:#fefefe;margin:0;color:#111;font-family:Ubuntu,Helvetica,Helvetica Neue,Arial,sans-serif;}
#secret {color:#efefef;}
#secret:hover {color:#ddd;}
#char {height:600px;width:600px;}
...
#opt svg {margin:3px;position:relative;}
    ...
    while (false !== ($svgfile = readdir($svghandle))) {
        if ($svgfile != "." && $svgfile != "..") {
        	...
        	$svgfilenm = str_replace('.svg', '', $svgfile);
			    $svgstring = str_replace('Layer_1', $svgfilenm, $svgwhole);
          $svgarray[] = $svgstring;
        }
    }
    closedir($svghandle);
